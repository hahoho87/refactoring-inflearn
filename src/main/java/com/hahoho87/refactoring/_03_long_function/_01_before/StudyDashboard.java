package com.hahoho87.refactoring._03_long_function._01_before;
...
public class StudyDashboard {
    ...
    private void print() throws IOException, InterruptedException {
        ...
        try (FileWriter fileWriter = new FileWriter("participants.md");
            ...
            participants.forEach(p -> {
                String markdownForHomework = getFormat(totalNumberOfEvents, p);
    ...
    private String getFormat(int totalNumberOfEvents, Participant p) {
