package com.hahoho87.refactoring._06_mutable_data._19_separate_query_from_modifier;
...
class CriminalTest {
    ...
    void alertForMiscreant() {
        ...
        found = criminal.findMiscreant(List.of(new Person("hahoho"), new Person("hohoho")));
        assertEquals("", found);
    }
